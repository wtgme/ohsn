...
5. get timelines of users in poi_collection and store them in timeline collections
    using: stream/streaming_user_timeline.py

6. set flag of users in poi collection according to the records in timeline collections.
...
7. perform text process with LIWC on users' timeline and store the results in poi collection
    using: analyser/lexiconsmaster/liwc_timeline_processor.py

8. profile text mining to generate gender and weight etc.
    using analyser/textprocessor/description_miner.py

9. network analysis based on users' timelines
