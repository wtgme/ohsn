...
NODECOLLECTION = 'testfollowernodes'
FOLLOWERCOLLECTION = 'testfollowers'
...
followers = db[FOLLOWERCOLLECTION]
...
def store_follower(follower, collection=followers):
...
def store_followers(followers, collection=followers):
...
def getfollowers(name, hop=0, maxhop=2, maxfollowers=200, nodes=nodes, edges=edges):
