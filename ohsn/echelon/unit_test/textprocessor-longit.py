...
#        and we need to embed the obsevations behind a tag on the poi
        ...
        if gw is not None:
            ...
            poi.update({ "id": tweet['interaction']['twitter']['user']['id']}, {'$push':{'text_anal.gw':{'datetime':tweeted_at,'source':source, 'ug':gw_ug, 'value':gw}}})
        ...
        if cw is not None:
            ...
            # push the observsation onto the timeseries:
            # user['text_anal']['cw'] = {(datetime, source, unit-conf, value),(datetime, source, unit-conf, value), .... (datetime, source, unit-conf, value)}
            poi.update({ "id": tweet['interaction']['twitter']['user']['id']}, {'$push':{'text_anal.cw':{'datetime':tweeted_at,'source':source, 'ug':cw_ug, 'value':cw}}})
        ...
        if hw is not None:
            ...
            # push the observsation onto the timeseries:
            # user['text_anal']['cw'] = {(datetime, source, unit-conf, value),(datetime, source, unit-conf, value), .... (datetime, source, unit-conf, value)}
            poi.update({ "id": tweet['interaction']['twitter']['user']['id']}, {'$push':{'text_anal.hw':{'datetime':tweeted_at,'source':source, 'ug':hw_ug, 'value':hw}}})
        ...
        if lw is not None:
            ...
            # push the observsation onto the timeseries:
            # user['text_anal']['cw'] = {(datetime, source, unit-conf, value),(datetime, source, unit-conf, value), .... (datetime, source, unit-conf, value)}
            poi.update({ "id": tweet['interaction']['twitter']['user']['id']}, {'$push':{'text_anal.lw':{'datetime':tweeted_at,'source':source, 'ug':lw_ug, 'value':lw}}})
        ...
        if h is not None:
            ...
            # user['text_anal']['cw'] = {(datetime, source, unit-conf, value),(datetime, source, unit-conf, value), .... (datetime, source, unit-conf, value)}
            poi.update({ "id": tweet['interaction']['twitter']['user']['id']}, {'$push':{'text_anal.h':{'datetime':tweeted_at,'source':source, 'value':h}}})
        ...
        if a is not None:
            ...
            # push the observsation onto the timeseries:
            # user['text_anal']['cw'] = {(datetime, source, unit-conf, value),(datetime, source, unit-conf, value), .... (datetime, source, unit-conf, value)}
            poi.update({ "id": tweet['interaction']['twitter']['user']['id']}, {'$push':{'text_anal.a':{'datetime':tweeted_at,'source':source, 'value':a}}})
    except Exception:
   ...
   # if its an official retweet ignore the tweet itself
    ...
    try:
        ...
        print "ERROR: timeeline update failed"
