...
from ohsn.echelon.datasift import textprocessor
...
ERROR_LOG_FILENAME = 'datasift-collection-processor_errorlog_' + datetime.datetime.now().strftime("%Y-%m-%d-%H-%M-%S") + '.log'
...
# DATASIFT_OBSERVATIONS_COLNAME = "datasift_all_observations"
...
#except Exception, e:
#	print DATASIFTMONGOUSER +" FAILED to connect to " + DATASIFTDBNAME + " " + e
#	exit()
