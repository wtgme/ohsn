...
try:
    ...
    mrredges.create_index([("id0", pymongo.ASCENDING), ("id1", pymongo.ASCENDING), ("relationship", pymongo.ASCENDING)])
    mrredges.create_index([("count", pymongo.ASCENDING)])
...
print "setting count to None on every mrredge"
mrredges.update({}, {'$set':{"count": None}}, multi=True)
