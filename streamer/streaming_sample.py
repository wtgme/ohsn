...
# spin up twitter api
APP_KEY = config.get('credentials2', 'app_key')
APP_SECRET = config.get('credentials2', 'app_secret')
OAUTH_TOKEN = config.get('credentials2', 'oath_token')
OAUTH_TOKEN_SECRET = config.get('credentials2', 'oath_token_secret')
print('loaded configuation')

# spin up database
DBNAME = 'stream'
COLLECTION = 'stream_sample'
...
while True:
    try:
        ...
        # Greater London: "51.2867602","51.6918741","-0.5103751","0.3340155"
        # UK  latitudes 49° to 61° N, and longitudes 9° W to 2° E
        # The United Kingdom lies between latitudes 49° to 61° N, and longitudes 9° W to 2° E.
